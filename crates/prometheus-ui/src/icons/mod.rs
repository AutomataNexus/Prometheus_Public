// ============================================================================
// File: mod.rs
// Description: Inline Lucide SVG icon functions for use throughout the UI
...
/// Inline Lucide SVG icons — no JS dependency required

/// Dashboard — 4-quadrant grid (control panel feel)
pub fn icon_home() -> impl IntoView {
    view! {
...
/// Datasets — stacked horizontal rows (spreadsheet/table)
...
/// Training — lightning bolt (energy/compute)
pub fn icon_brain() -> impl IntoView {
    view! {
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
...
/// Models — isometric cube wireframe (3D model artifact)
pub fn icon_package() -> impl IntoView {
    view! {
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
...
/// Deployment — crosshair/target (precision edge deploy)
pub fn icon_rocket() -> impl IntoView {
    view! {
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
...
/// Evaluation — scope/magnifier with ruler marks (inspection)
pub fn icon_chart() -> impl IntoView {
    view! {
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
...
/// Agent — terminal prompt cursor (command/AI interface)
pub fn icon_bot() -> impl IntoView {
    view! {
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
...
/// Settings — horizontal slider controls (mixer/tuning)
...
pub fn icon_bell() -> impl IntoView {
    view! {
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
pub fn icon_file_text() -> impl IntoView {
    view! {
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
pub fn icon_loader() -> impl IntoView {
    view! {
...
pub fn icon_user_plus() -> impl IntoView {
    view! {
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
pub fn icon_mail() -> impl IntoView {
    view! {
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
/// Convert — two interlocked gears (transformation/processing)
pub fn icon_convert() -> impl IntoView {
    leptos::prelude::view! {
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
            <path d="M4 12V8a4 4 0 0 1 4-4h3"/>
            <polyline points="14 7 11 4 14 1"/>
            <path d="M20 12v4a4 4 0 0 1-4 4h-3"/>
            <polyline points="10 17 13 20 10 23"/>
        </svg>
    }
}

/// Wallet — billing/payments icon
pub fn icon_wallet() -> impl IntoView {
    leptos::prelude::view! {
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
